...
public class GameBoardFull extends GameBoard {
    public GameBoardFull() {
        ...
        IOwner cc1 = new CardCell(Card.TYPE_CC, "Community Chest 1");
        ...
        IOwner c1 = new CardCell(Card.TYPE_CHANCE, "Chance 1");
        ...
        IOwner cc2 = new CardCell(Card.TYPE_CC, "Community Chest 2");
        ...
        IOwner c2 = new CardCell(Card.TYPE_CHANCE, "Chance 2");
        ...
        IOwner cc3 = new CardCell(Card.TYPE_CC, "Community Chest 3");
        PropertyCell g3 = new PropertyCell();
        RailRoadCell rr4 = new RailRoadCell();
        IOwner c3 = new CardCell(Card.TYPE_CHANCE, "Chance 3");
